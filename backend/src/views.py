...
def get_place_website(place_id: str, gmaps_client) -> Optional[str]:
    """
    Get place website. If no website present, returns None

    Args:
        place_id: ID of inputted place

    Returns:
        Place website.
    """
    place_details = gmaps_client.place(place_id)
